    ...
    return (
      <View
        style={[
          ...
          {
            backgroundColor:
              currentHour === index ? COLORS.BLACK : COLORS.WHITE_COLOR,
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.summaryContainer}>
          ...
          <Text style={styles.summaryText}>
            {`The temperature today is in the range from \n+${Math.ceil(
              hourlyData?.day?.mintemp_c
            )}° to +${Math.ceil(hourlyData?.day?.maxtemp_c)}°`}
          </Text>
        </View>
